...
public class NTPClient
{
	public static void main(String[] args) throws IOException
	{
		...
		*/
        ...
        System.out.println("Time server took to process the request: " +
            new DecimalFormat("0.00").format(msg.transmitTimestamp - msg.receiveTimestamp) + " ms");

        System.out.println("One way delay for server to recieve the request: " +
            new DecimalFormat("0.00").format(msg.receiveTimestamp - msg.originateTimestamp) + " ms");
